...
This Site
This is very basic site made using pure HTML, JavaScript, and CSS, with little to no (3rd party) libraries used.
...
Also this site should work mostly without JavaScript. JS should only be use for bonus stuff.
